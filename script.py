...
def get_news_summary(video_title, gemini_api_key):
    ...
    prompt = f"Using this news title: '{video_title}'. Provide a detailed news summary and attractive title in sinhala as json format without any markdown code blocks or additional text. Only return the json object. Include only title and summary field"
    try:
